...
import AirEau1 from '../../assets/AirEau1.jpeg';
              ...
              <div className="bg-emerald-900 p-12 text-white flex flex-col justify-center">
                ...
                <div className="space-y-4 mb-8">
                  {[
                    ...
                    "Chauffage et eau chaude sanitaire en un seul équipement",
                ...
                <div className="space-y-4">
                  <button 
                  onClick={() => onPageChange && onPageChange('simulateur-pompe-a-chaleur-air-eau')}

...
import Ampleur1 from '../../assets/Ampleur1.jpg'; 
          ...
          <div className="bg-white rounded-3xl shadow-xl overflow-hidden max-w-5xl w-full">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              <div className="bg-emerald-900 p-12 text-white flex flex-col justify-center">
                ...
                <div className="space-y-4 mb-8">
                  {[
                    ...
                    "Aides financières maximisées jusqu'à 90%",
                  ].map((text, idx) => (
                ...
                <div className="space-y-4">
                  <button 
                  onClick={() => onPageChange && onPageChange('simulateur-renovation-ampleur')}
              ...
              <div className="relative">
                <img
                  src={Ampleur1}
                  alt="Rénovation d'ampleur d'une maison"

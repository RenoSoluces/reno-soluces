...
import Batterie1 from '../../assets/Batterie1.jpg';
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              <div className="bg-emerald-900 p-12 text-white flex flex-col justify-center">
                <h1 className="text-4xl font-bold mb-8 leading-tight">
                  Stockez votre énergie solaire<br />
                  avec une batterie adaptée<br />
                  à vos besoins
                </h1>

                <div className="space-y-4 mb-8"> 
                  {[
                    'Optimisez votre autoconsommation grâce au stockage',
                    'Fiabilité et performance avec la marque SolarEdge',
                ...
                <div className="space-y-4">
                  <button 
                    onClick={() => onPageChange && onPageChange('simulateur-photovoltaique')}
              ...
              <div className="relative">
                <img
                  src={Batterie1}
                  alt="Batterie de stockage pour panneaux solaires"

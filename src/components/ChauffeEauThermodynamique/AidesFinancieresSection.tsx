    ...
    <section className="bg-emerald-900 py-16">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-white text-center">
        ...
        <p className="text-lg text-green-100 mb-10">
          Le chauffe-eau thermodynamique est éligible à plusieurs dispositifs de financement.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-8 text-left">
          {[
            {
              title: 'MaPrimeRénov\'',
              desc: 'Aide de l\'État pouvant aller jusqu\'à 1 200€ selon vos revenus pour l\'installation d\'un chauffe-eau thermodynamique.'
            },
            {
            ...
            },
            {
              ...
              desc: 'Prêt sans intérêts jusqu\'à 15 000€ pour financer votre chauffe-eau thermodynamique.'
            }
          ].map((item, idx) => (
        ...
        <div className="mt-12">
          <button 
          onClick={() => onPageChange && onPageChange('simulateur-produire-mon-eau-chaude')}
